            ...
            <div className="ed-contact__info-wrapper">
              ...
              <div className="ed-contact__info-item">
                ...
                <div className="ed-contact__info-content">
                  <span>Connect 10:30 to 6:00 PM</span>
                  <a href="tel:+9102402332040">0240 2332040</a>
                </div>
              </div>
              {/* Sigle Info  */}
              <div className="ed-contact__info-item">
                ...
                <div className="ed-contact__info-content">
                  ...
                  <a href="mailto:eduna@gmail.com">sbacinquiry@gmail.com3</a>
                </div>
              </div>
              {/* Sigle Info  */}
              <div className="ed-contact__info-item">
                ...
                <div className="ed-contact__info-content">
                  ...
                  <a href="#"> Saraswati Colony, Aurangpura, Chhatrapti Sambhajinagar, 431001, MH, India</a>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              <div className="ed-contact__form-head">
                ...
                <h3 className="ed-contact__form-big-title">
                  Have Any Questions Or Admission Inquiry? <br />
                </h3>
              </div>
